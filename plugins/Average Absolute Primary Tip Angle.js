...
const name = "Average Absolute Primary Tip Angle";
const id = 'avgAbsTipPrimaryAngle';
const description = "Mean absolte angle in degrees of all primary root tips relative to vertical, per plant";
...
const plugin = (rsmlJson, polylines, utils) => {
	return new Promise((resolve, reject) => {
        ...
        polylines.filter(line => line.type == "primary").forEach((line, index) => {
            ...
            let angle = Math.abs(utils.boundAngle(utils.gradientToAngle(points, gradient)));
